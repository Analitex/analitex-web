...
export function FilterBar({
  ...
  const showFilters = currentPage !== 'settings';
  ...
  return (
    <>
      <div className="border-b border-slate-200 bg-white px-4 py-3 sm:px-6">
        {!showFilters && activeSettingsTab && onSettingsTabChange && (
              ...
              {SETTINGS_TABS.map(tab => {
                ...
                return (
                  <button
                    ...
                    className={`inline-flex h-11 shrink-0 items-center gap-2 border-b-2 bg-transparent px-0 text-sm font-semibold transition-colors ${
