              ...
              {mode === 'register' && (
                <div>
                  <ConsentLine
                    ...
                    required
                    label="Я ознакомлен(-на) с Политикой конфиденциальности, публичной офертой на использование программного продукта и даю согласие на обработку моих персональных данных. Я уведомлен(-а) о праве отозвать согласие в любой момент."
                  />
                  <ConsentLine
                    checked={marketingConsent}
                    onChange={setMarketingConsent}
                    label="Я согласен(-на) на получение информационных и маркетинговых сообщений."
                  />
                </div>
              )}
